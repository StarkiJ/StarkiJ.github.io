...
var core = require("../../tools/offer-compare/js/core.js");
var taxPolicy = require("../../tools/offer-compare/js/tax-policy.js");
...
assert.strictEqual(
    core.createDefaultState().settings.year,
...
assertStateFile("examples.json", true);
assertStateFile("private.json", false);
assertCompactExampleScheduleDays();

console.log("offer-compare core tests passed");
