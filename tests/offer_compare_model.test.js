...
var vm = require("vm");
var model = require("../tools/js/offer_compare_model.js");
...
var browserSource = fs.readFileSync(
    path.join(__dirname, "..", "tools", "js", "offer_compare_model.js"),
    "utf8"
);
var browserContext = {
    window: {}
...
vm.runInNewContext(browserSource, browserContext, {
    filename: "offer_compare_model.js"
});
assert.strictEqual(
...
console.log("offer_compare_model tests passed");
